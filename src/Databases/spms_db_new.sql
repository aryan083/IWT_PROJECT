...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2024 at 09:54 PM
...
--
-- Table structure for table `spms_events`
--

CREATE TABLE `spms_events` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `spms_events`
--
ALTER TABLE `spms_events`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `spms_events`
--
ALTER TABLE `spms_events`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
